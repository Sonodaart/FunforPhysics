...
var sss, ttt, iii, sos, xxx, yyy, rk1, rk2, op1, op2;
...
function setPieces() {
  ...
  for (i = 0; i < 2; i++)
    pezziNeri.push(new Pezzo(5 * i + 1, 0, 64, imgpezzo[2], 2, "knight", "black"));
  for (i = 0; i < 2; i++)
    pezziNeri.push(new Pezzo(i * 7, 0, 64, imgpezzo[3], 3, "rook", "black"));
  pezziNeri.push(new Pezzo(3, 0, 64, imgpezzo[4], 4, "queen", "black"));
...
class Pezzo {
  ...
  constructor(_x, _y, _l, _img, _indexImage, _type, _colour) {
    this.xx = _x;
    this.yy = _y;
    this.img = _img;
    this.ll = _l;
      ...
      if (z != bbbb) {
        switch (pezziNeri[z].type) {
          case "pawn":
            ...
            for (q = 0; q < pezziNeri.length; q++) {
              if (pezziNeri[q].xx == pezziNeri[z].xx && pezziNeri[q] == pezziNeri[z].yy + 1 && q != bbbb) {
                caso1 = false;
                break;
              }
              if (pezziNeri[z].yy == 1 && pezziNeri[q].xx == pezziNeri[z].xx && pezziNeri[q].yy == pezziNeri[z].yy + 2 && q != bbbb) {
                caso2 = false;
                break;
              }
            }
            ...
            for (q = -1; q < 2; q += 2) {
              for (a = -1; a < 2; a += 2) {
                ...
                for (aa = 0; aa < pezziNeri.length; aa++) {
                  ...
                  if (caso1 && pezziNeri[aa].xx == pezziNeri[z].xx + q * 2 && pezziNeri[aa].yy == pezziNeri[z].yy + a && aa != bbbb) {
                    caso2 = false;
                  }
                }
  ...
  isAValidMoveforBlack(endX, endY, index) {
    if (pezziNeri[0].updateBlackMoves(endX, endY, index)) {
      print(1);
      checkMate = "white";
      return false;
    }
      ...
      if (z != bbbb) {
        switch (pezziBianchi[z].type) {
          case "pawn":
            ...
            for (q = 0; q < pezziBianchi.length; q++) {
              if (pezziBianchi[q].xx == pezziBianchi[z].xx && pezziBianchi[q] == pezziBianchi[z].yy - 1 && q != bbbb) {
                caso1 = false;
                break;
              }
  ...
  isAValidMoveforWhite(endX, endY, index) {
    if (pezziBianchi[0].updateWhiteMoves(endX, endY, index)) {
      print(2);
      checkMate = "black";
      return false;
    }
